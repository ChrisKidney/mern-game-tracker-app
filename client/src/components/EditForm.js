...
class EditForm extends React.Component {
    ...
    componentDidMount() {
        dataService.getGame(this.props.params.id, (err, success, data) => {
    ...
    handleSubmit = (e) => {
        ...
        if (errors.length === 0) {
            dataService.updateGame(this.state.data, (err, success) => {
                if (!success) {
                    const errors = [];
                    const error = {};
                    console.log(err);
    ...
    render() {
        return ( 
            <form className="form-create" onSubmit={this.handleSubmit}>
                <h1 className="h3 mb-3 font-weight-normal text-center">Edit Game</h1>
                ...
                <div className="row mb-3">
                    <div className="col-6">
                        ...
                        <input 
                            ...
                            value={this.state.data.steam_app_id}
                            autoFocus
                        ...
                        <input 
                            ...
                            value={this.state.data.developer}
                            autoFocus
                        />
                        {
                    ...
                    <div className="col-6">
                        ...
                        <input 
                            ...
                            value={moment(this.state.data.release_date).format('YYYY-MM-DD')} 
                            autoFocus
                        />
                        {
                        ...
                        <div className="form-check">
                            <input 
                                ...
                                className="form-check-input" 
                                onChange={this.handleChange}
                                checked={this.state.data.completion_status.beaten}
                            />
                        ...
                        <div className="form-check">
                            <input 
                                ...
                                className="form-check-input" 
                                onChange={this.handleChange}
                                checked={this.state.data.completion_status.completed_achievements}
                            />
                        ...
                        <div className="form-check">
                            <input 
                                ...
                                className="form-check-input" 
                                onChange={this.handleChange}
                                checked={this.state.data.completion_status.endless}
                            />
                            <label className="form-check-label" htmlFor="flexCheckDefault">
                                Endless
                            </label>
                        ...
                        <div className="form-check">
                            <input 
                                ...
                                className="form-check-input" 
                                onChange={this.handleChange}
                                checked={this.state.data.completion_status.on_hold}
                            />
                            <label className="form-check-label" htmlFor="flexCheckDefault">
                                On Hold
                            </label>
                        ...
                        <div className="form-check">
                            <input 
                                ...
                                className="form-check-input" 
                                onChange={this.handleChange}
                                checked={this.state.data.completion_status.dropped}
                            />
                            <label className="form-check-label" htmlFor="flexCheckDefault">
                                Dropped
                            </label>
                ...
                <button className="btn btn-lg btn-primary btn-block" type="submit">Save Edit</button>
            </form>
         );
    }
}
 
export default withNavigate(EditForm);